...
Send "/g2 "
w8
Send "preAr[&DQcXHi06KB9tAW0BtgG2AYABgAF/AYMBvAG8AQAAAAAAAAAAAAAAAAAAAAADVgBXAFkAAA==]." A_Clipboard ; grab previously saved template from cliboard - prepend it with the precast template
w8
Send "{Enter}"
w8
