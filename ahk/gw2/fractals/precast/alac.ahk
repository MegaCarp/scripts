...
Send "/g2 "
w8
Send "preA[&DQcXPi06KB9tAW0BtgG2AYABgAHPEoMBvAG8AQAAAAAAAAAAAAAAAAAAAAADWQBWAFcAAA==]." A_Clipboard ; grab previously saved template from cliboard - prepend it with the precast template
w8
Send "{Enter}"
w8
